...
//#cgo linux,!llua,!luaa,!luajit LDFLAGS: lua5.1.x
package lua

/*
#cgo CFLAGS: -I ${SRCDIR}/lua
#cgo llua LDFLAGS: -llua-5.1.x
#cgo luaa LDFLAGS: -llua -lm -ldl
#cgo luajit LDFLAGS: -lluajit-5.1
#cgo linux,!llua,!luaa,!luajit LDFLAGS: -lonion -ldl -lreadline -lhistory -lncurses -lm -L${SRCDIR}/lua/ -llua515x
#cgo darwin,!luaa,!luajit pkg-config: lua5.1.x
#cgo freebsd,!luaa,!luajit LDFLAGS: -llua-5.1.x
